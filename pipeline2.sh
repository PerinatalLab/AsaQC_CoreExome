...
echo "################################"
echo "Launching PLINK to filter SNPs for individual QC round 1"
${PLINK} \
--bfile ${FILENAME} \
...
--make-bed \
--out ./QC_snp_2/${FILENAME}_filtered
...
${PLINK} \
--bfile ./QC_snp_2/${FILENAME}_filtered \
--missing \
--het \
--mendel \
--mendel-duos \
...
# plink to filter individuals
echo "################################"
echo "Launching PLINK for final filtering of individiduals"
${PLINK} \
--bfile ./QC_snp_2/${FILENAME}_filtered \
