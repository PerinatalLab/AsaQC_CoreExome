...
Analysis report of QC SNP statistics
========================================================
...
n_excl4=totalS-sum(hist4$counts[1:sum(hist4$breaks<=-log(hwe_cutoff,base=10))],na.rm=T)
...
SNPs flagged by HWET filter: `r fail_hwe`  
